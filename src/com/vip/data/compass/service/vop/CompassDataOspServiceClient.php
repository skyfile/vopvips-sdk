...
class CompassDataOspServiceClient{
	...
	public static function getService(){
		...
		if (! CompassDataOspServiceClient::$isRegis){
			
			CompassDataOspServiceClient::regis ();
			CompassDataOspServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = CompassDataOspServiceClient::$DEFAULT_PROXY_IP;
		$port = CompassDataOspServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\data\compass\service\vop\CompassDataOspServiceHelper();
	}
