...
class VopCipherServiceClient{
	...
	public static function getService(){
		...
		if (! VopCipherServiceClient::$isRegis){
			
			VopCipherServiceClient::regis ();
			VopCipherServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VopCipherServiceClient::$DEFAULT_PROXY_IP;
		$port = VopCipherServiceClient::$DEFAULT_PROXY_PORT;	
		try{
