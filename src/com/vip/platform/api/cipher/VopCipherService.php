...
class _VopCipherServiceClient extends \Osp\Base\OspStub implements \com\vip\platform\api\cipher\VopCipherServiceIf{
	
	public function __construct(){
		
		parent::__construct("com.vip.platform.api.cipher.VopCipherService", "1.0.0");
	}
	...
	public function createAllStoreKey(){
		...
		$this->send_createAllStoreKey();
		return $this->recv_createAllStoreKey();
	}
...
class VopCipherService_batchDecrypt_args {
...
class VopCipherService_batchEncrypt_args {
...
class VopCipherService_createAllStoreKey_args {
...
class VopCipherService_createKey_args {
...
class VopCipherService_healthCheck_args {
...
class VopCipherService_batchDecrypt_result {
...
class VopCipherService_batchEncrypt_result {
...
class VopCipherService_createAllStoreKey_result {
...
class VopCipherService_createKey_result {
...
class VopCipherService_healthCheck_result {
