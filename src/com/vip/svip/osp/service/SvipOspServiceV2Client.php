...
class SvipOspServiceV2Client{
	...
	public static function getService(){
		...
		if (! SvipOspServiceV2Client::$isRegis){
			
			SvipOspServiceV2Client::regis ();
			SvipOspServiceV2Client::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = SvipOspServiceV2Client::$DEFAULT_PROXY_IP;
		$port = SvipOspServiceV2Client::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\svip\osp\service\SvipOspServiceV2Helper();
	}
