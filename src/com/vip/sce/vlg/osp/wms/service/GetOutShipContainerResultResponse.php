...
class GetOutShipContainerResultResponse {
	...
	public function getName(){
		...
		return 'GetOutShipContainerResultResponse';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("body" == $schemeField){
				...
				$this->body = new \Voop\com\vip\sce\vlg\osp\wms\service\GetOutShipContainerResultBodyResponse();
