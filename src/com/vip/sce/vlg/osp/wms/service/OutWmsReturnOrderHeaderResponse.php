...
class OutWmsReturnOrderHeaderResponse {
	...
	public function getName(){
		...
		return 'OutWmsReturnOrderHeaderResponse';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("body" == $schemeField){
				...
				$this->body = new \Voop\com\vip\sce\vlg\osp\wms\service\OutWmsReturnOrderBodyResponse();
