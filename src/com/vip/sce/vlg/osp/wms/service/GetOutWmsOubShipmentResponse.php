...
class GetOutWmsOubShipmentResponse {
	...
	public function getName(){
		...
		return 'GetOutWmsOubShipmentResponse';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("body" == $schemeField){
				...
				$this->body = new \Voop\com\vip\sce\vlg\osp\wms\service\GetOutWmsOubShipmentBodyResponse();
