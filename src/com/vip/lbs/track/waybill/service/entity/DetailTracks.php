...
class DetailTracks {
	...
	public function read($input){
		...
		while(true){
			...
			if ("coordinateSystem" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->coordinateSystem);
	...
	public function write($output){
		...
		if($this->coordinateSystem !== null) {
			...
			$xfer += $output->writeFieldBegin('coordinateSystem');
			$xfer += $output->writeString($this->coordinateSystem);
