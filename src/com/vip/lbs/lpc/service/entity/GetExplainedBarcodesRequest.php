...
class GetExplainedBarcodesRequest {
	...
	static $_TSPEC;
	public $header = null;
	public $explainedBarcodesModelList = null;
	...
	public function __construct($vals=null){
		...
		if (!isset(self::$_TSPEC)){
			...
			2 => array(
			'var' => 'explainedBarcodesModelList'
			),
		...
		if (is_array($vals)){
			...
			if (isset($vals['explainedBarcodesModelList'])){
				
				$this->explainedBarcodesModelList = $vals['explainedBarcodesModelList'];
			}
	...
	public function getName(){
		...
		return 'GetExplainedBarcodesRequest';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("explainedBarcodesModelList" == $schemeField){
				
				$needSkip = false;
				
				$this->explainedBarcodesModelList = array();
				$_size0 = 0;
				$input->readListBegin();
				while(true){
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('explainedBarcodesModelList');
		...
		foreach ($this->explainedBarcodesModelList as $iter0){
