...
class WorkOrderServiceClient{
	...
	public static function getService(){
		...
		if (! WorkOrderServiceClient::$isRegis){
			
			WorkOrderServiceClient::regis ();
			WorkOrderServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = WorkOrderServiceClient::$DEFAULT_PROXY_IP;
		$port = WorkOrderServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\vop\omni\wo\WorkOrderServiceHelper();
	}
