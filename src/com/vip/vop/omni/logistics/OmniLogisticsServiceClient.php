...
class OmniLogisticsServiceClient{
	...
	public static function getService(){
		...
		if (! OmniLogisticsServiceClient::$isRegis){
			
			OmniLogisticsServiceClient::regis ();
			OmniLogisticsServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = OmniLogisticsServiceClient::$DEFAULT_PROXY_IP;
		$port = OmniLogisticsServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\vop\omni\logistics\OmniLogisticsServiceHelper();
	}
