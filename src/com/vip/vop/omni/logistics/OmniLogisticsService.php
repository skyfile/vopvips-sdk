...
interface OmniLogisticsServiceIf{
	...
	public function getOrderLogisticsTrack(\Voop\com\vip\vop\omni\logistics\LogisticsTrackRequest $trackRequest);
	
	public function healthCheck();
	
	public function receiveMaxSpeedRouteInfo(\Voop\com\vip\vop\omni\logistics\MaxSpeedRouteInfo $maxSpeedRouteInfo);
	
	public function receiveRouteInfo(\Voop\com\vip\vop\omni\logistics\WaybillRoute $waybillRoute);
	
	public function receiveYtoRouteInfo(\Voop\com\vip\vop\omni\logistics\YtoRouteInfo $ytoRouteInfo);
	
	public function receiveZtoRouteInfo(\Voop\com\vip\vop\omni\logistics\ZtoRouteInfo $ztoRouteInfo);
...
class _OmniLogisticsServiceClient extends \Voop\Osp\Base\OspStub implements \com\vip\vop\omni\logistics\OmniLogisticsServiceIf{
	...
	public function send_getOrderLogisticsTrack(\Voop\com\vip\vop\omni\logistics\LogisticsTrackRequest $trackRequest){
		
		$this->initInvocation("getOrderLogisticsTrack");
		$args = new \Voop\com\vip\vop\omni\logistics\OmniLogisticsService_getOrderLogisticsTrack_args();
	...
	public function recv_getOrderLogisticsTrack(){
		...
		$result = new \Voop\com\vip\vop\omni\logistics\OmniLogisticsService_getOrderLogisticsTrack_result();
	...
	public function send_healthCheck(){
		...
		$args = new \Voop\com\vip\vop\omni\logistics\OmniLogisticsService_healthCheck_args();
	...
	public function recv_healthCheck(){
		...
		$result = new \Voop\com\vip\vop\omni\logistics\OmniLogisticsService_healthCheck_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_receiveMaxSpeedRouteInfo(\Voop\com\vip\vop\omni\logistics\MaxSpeedRouteInfo $maxSpeedRouteInfo){
		
		$this->initInvocation("receiveMaxSpeedRouteInfo");
		$args = new \Voop\com\vip\vop\omni\logistics\OmniLogisticsService_receiveMaxSpeedRouteInfo_args();
	...
	public function recv_receiveMaxSpeedRouteInfo(){
		...
		$result = new \Voop\com\vip\vop\omni\logistics\OmniLogisticsService_receiveMaxSpeedRouteInfo_result();
		$this->receive_base($result);
	...
	public function send_receiveRouteInfo(\Voop\com\vip\vop\omni\logistics\WaybillRoute $waybillRoute){
		
		$this->initInvocation("receiveRouteInfo");
		$args = new \Voop\com\vip\vop\omni\logistics\OmniLogisticsService_receiveRouteInfo_args();
	...
	public function recv_receiveRouteInfo(){
		...
		$result = new \Voop\com\vip\vop\omni\logistics\OmniLogisticsService_receiveRouteInfo_result();
		$this->receive_base($result);
	...
	public function send_receiveYtoRouteInfo(\Voop\com\vip\vop\omni\logistics\YtoRouteInfo $ytoRouteInfo){
		
		$this->initInvocation("receiveYtoRouteInfo");
		$args = new \Voop\com\vip\vop\omni\logistics\OmniLogisticsService_receiveYtoRouteInfo_args();
	...
	public function recv_receiveYtoRouteInfo(){
		...
		$result = new \Voop\com\vip\vop\omni\logistics\OmniLogisticsService_receiveYtoRouteInfo_result();
		$this->receive_base($result);
	...
	public function send_receiveZtoRouteInfo(\Voop\com\vip\vop\omni\logistics\ZtoRouteInfo $ztoRouteInfo){
		
		$this->initInvocation("receiveZtoRouteInfo");
		$args = new \Voop\com\vip\vop\omni\logistics\OmniLogisticsService_receiveZtoRouteInfo_args();
	...
	public function recv_receiveZtoRouteInfo(){
		...
		$result = new \Voop\com\vip\vop\omni\logistics\OmniLogisticsService_receiveZtoRouteInfo_result();
		$this->receive_base($result);
...
class OmniLogisticsService_getOrderLogisticsTrack_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->trackRequest = new \Voop\com\vip\vop\omni\logistics\LogisticsTrackRequest();
...
class OmniLogisticsService_receiveMaxSpeedRouteInfo_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->maxSpeedRouteInfo = new \Voop\com\vip\vop\omni\logistics\MaxSpeedRouteInfo();
...
class OmniLogisticsService_receiveRouteInfo_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->waybillRoute = new \Voop\com\vip\vop\omni\logistics\WaybillRoute();
...
class OmniLogisticsService_receiveYtoRouteInfo_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->ytoRouteInfo = new \Voop\com\vip\vop\omni\logistics\YtoRouteInfo();
...
class OmniLogisticsService_receiveZtoRouteInfo_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->ztoRouteInfo = new \Voop\com\vip\vop\omni\logistics\ZtoRouteInfo();
...
class OmniLogisticsService_getOrderLogisticsTrack_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \Voop\com\vip\vop\omni\logistics\LogisticsTrackResponse();
