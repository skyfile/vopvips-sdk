...
class VdgHistoryDataServiceClient{
	...
	public static function getService(){
		...
		if (! VdgHistoryDataServiceClient::$isRegis){
			
			VdgHistoryDataServiceClient::regis ();
			VdgHistoryDataServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VdgHistoryDataServiceClient::$DEFAULT_PROXY_IP;
		$port = VdgHistoryDataServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\vop\vcloud\history\VdgHistoryDataServiceHelper();
	}
