...
class ProductAdminServiceClient{
	...
	public static function getService(){
		...
		if (! ProductAdminServiceClient::$isRegis){
			
			ProductAdminServiceClient::regis ();
			ProductAdminServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ProductAdminServiceClient::$DEFAULT_PROXY_IP;
		$port = ProductAdminServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\vop\vcloud\product\ProductAdminServiceHelper();
	}
