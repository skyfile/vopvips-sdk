...
interface DieselCategorySynServiceIf{
	...
	public function processCategoryItem();
	
}

class _DieselCategorySynServiceClient extends \Osp\Base\OspStub implements \com\vip\vop\vcloud\product\DieselCategorySynServiceIf{
	
	public function __construct(){
		
		parent::__construct("com.vip.vop.vcloud.product.DieselCategorySynService", "1.0.0");
	}
	...
	public function processCategoryItem(){
		...
		$this->send_processCategoryItem();
		return $this->recv_processCategoryItem();
	}
...
class DieselCategorySynService_healthCheck_args {
...
class DieselCategorySynService_processCategoryItem_args {
...
class DieselCategorySynService_healthCheck_result {
...
class DieselCategorySynService_processCategoryItem_result {
