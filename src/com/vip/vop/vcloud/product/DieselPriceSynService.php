...
interface DieselPriceSynServiceIf{
	...
	public function processPriceItem();
	
	public function pushPriceToVdg();
...
class _DieselPriceSynServiceClient extends \Osp\Base\OspStub implements \com\vip\vop\vcloud\product\DieselPriceSynServiceIf{
	...
	public function __construct(){
		...
		parent::__construct("com.vip.vop.vcloud.product.DieselPriceSynService", "1.0.0");
	}
	...
	public function processPriceItem(){
		...
		$this->send_processPriceItem();
		return $this->recv_processPriceItem();
	}
	...
	public function pushPriceToVdg(){
		...
		$this->send_pushPriceToVdg();
		return $this->recv_pushPriceToVdg();
	}
...
class DieselPriceSynService_healthCheck_args {
...
class DieselPriceSynService_processPriceItem_args {
...
class DieselPriceSynService_pushPriceToVdg_args {
...
class DieselPriceSynService_healthCheck_result {
...
class DieselPriceSynService_processPriceItem_result {
...
class DieselPriceSynService_pushPriceToVdg_result {
