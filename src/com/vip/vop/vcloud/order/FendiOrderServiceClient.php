...
class FendiOrderServiceClient{
	...
	public static function getService(){
		...
		if (! FendiOrderServiceClient::$isRegis){
			
			FendiOrderServiceClient::regis ();
			FendiOrderServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = FendiOrderServiceClient::$DEFAULT_PROXY_IP;
		$port = FendiOrderServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\vop\vcloud\order\FendiOrderServiceHelper();
	}
