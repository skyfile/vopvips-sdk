...
class InventoryServiceClient{
	...
	public static function getService(){
		...
		if (! InventoryServiceClient::$isRegis){
			
			InventoryServiceClient::regis ();
			InventoryServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = InventoryServiceClient::$DEFAULT_PROXY_IP;
		$port = InventoryServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\vop\vcloud\inventory\api\InventoryServiceHelper();
	}
