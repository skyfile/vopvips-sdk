...
class AppSwitcherServiceClient{
	...
	public static function getService(){
		...
		if (! AppSwitcherServiceClient::$isRegis){
			
			AppSwitcherServiceClient::regis ();
			AppSwitcherServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = AppSwitcherServiceClient::$DEFAULT_PROXY_IP;
		$port = AppSwitcherServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\vop\common\switcher\AppSwitcherServiceHelper();
	}
