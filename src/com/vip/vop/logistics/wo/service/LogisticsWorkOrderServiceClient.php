...
class LogisticsWorkOrderServiceClient{
	...
	public static function getService(){
		...
		if (! LogisticsWorkOrderServiceClient::$isRegis){
			
			LogisticsWorkOrderServiceClient::regis ();
			LogisticsWorkOrderServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = LogisticsWorkOrderServiceClient::$DEFAULT_PROXY_IP;
		$port = LogisticsWorkOrderServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\vop\logistics\wo\service\LogisticsWorkOrderServiceHelper();
	}
