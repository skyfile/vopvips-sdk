...
class WorkOrderRecheckResult {
	...
	public $reckeck_reply_content = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['reckeck_reply_content'])){
				
				$this->reckeck_reply_content = $vals['reckeck_reply_content'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("reckeck_reply_content" == $schemeField){
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('reckeck_reply_content');
