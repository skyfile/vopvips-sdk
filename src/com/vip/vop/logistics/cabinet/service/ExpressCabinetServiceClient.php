...
class ExpressCabinetServiceClient{
	...
	public static function getService(){
		...
		if (! ExpressCabinetServiceClient::$isRegis){
			
			ExpressCabinetServiceClient::regis ();
			ExpressCabinetServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ExpressCabinetServiceClient::$DEFAULT_PROXY_IP;
		$port = ExpressCabinetServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\vop\logistics\cabinet\service\ExpressCabinetServiceHelper();
	}
