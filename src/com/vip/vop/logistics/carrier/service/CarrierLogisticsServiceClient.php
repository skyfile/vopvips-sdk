...
class CarrierLogisticsServiceClient{
	...
	public static function getService(){
		...
		if (! CarrierLogisticsServiceClient::$isRegis){
			
			CarrierLogisticsServiceClient::regis ();
			CarrierLogisticsServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = CarrierLogisticsServiceClient::$DEFAULT_PROXY_IP;
		$port = CarrierLogisticsServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\vop\logistics\carrier\service\CarrierLogisticsServiceHelper();
	}
