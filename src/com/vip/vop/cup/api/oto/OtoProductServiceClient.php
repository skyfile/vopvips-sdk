...
class OtoProductServiceClient{
	...
	public static function getService(){
		...
		if (! OtoProductServiceClient::$isRegis){
			
			OtoProductServiceClient::regis ();
			OtoProductServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = OtoProductServiceClient::$DEFAULT_PROXY_IP;
		$port = OtoProductServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\vop\cup\api\oto\OtoProductServiceHelper();
	}
