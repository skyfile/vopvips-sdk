...
class PmsDataServiceClient{
	...
	public static function getService(){
		...
		if (! PmsDataServiceClient::$isRegis){
			
			PmsDataServiceClient::regis ();
			PmsDataServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = PmsDataServiceClient::$DEFAULT_PROXY_IP;
		$port = PmsDataServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\pms\data\service\PmsDataServiceHelper();
	}
