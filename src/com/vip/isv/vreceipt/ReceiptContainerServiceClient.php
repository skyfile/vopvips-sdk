...
class ReceiptContainerServiceClient{
	...
	public static function getService(){
		...
		if (! ReceiptContainerServiceClient::$isRegis){
			
			ReceiptContainerServiceClient::regis ();
			ReceiptContainerServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ReceiptContainerServiceClient::$DEFAULT_PROXY_IP;
		$port = ReceiptContainerServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\isv\vreceipt\ReceiptContainerServiceHelper();
	}
