...
class _ReceiptContainerServiceClient extends \Voop\Osp\Base\OspStub implements \com\vip\isv\vreceipt\ReceiptContainerServiceIf{
	...
	public function __construct(){
		...
		parent::__construct("com.vip.isv.vreceipt.ReceiptContainerService", "1.0.0");
	}
...
class ReceiptContainerService_addReceiptContainer_args {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['revinfo'])){
				
				$this->revinfo = $vals['revinfo'];
			}
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('revinfo');
...
class ReceiptContainerService_healthCheck_args {
...
class ReceiptContainerService_addReceiptContainer_result {
...
class ReceiptContainerService_healthCheck_result {
