...
class ReturnOrderServiceClient{
	...
	public static function getService(){
		...
		if (! ReturnOrderServiceClient::$isRegis){
			
			ReturnOrderServiceClient::regis ();
			ReturnOrderServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ReturnOrderServiceClient::$DEFAULT_PROXY_IP;
		$port = ReturnOrderServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\isv\vreturn\ReturnOrderServiceHelper();
	}
