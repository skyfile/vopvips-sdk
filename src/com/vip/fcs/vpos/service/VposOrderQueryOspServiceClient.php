...
class VposOrderQueryOspServiceClient{
	...
	public static function getService(){
		...
		if (! VposOrderQueryOspServiceClient::$isRegis){
			
			VposOrderQueryOspServiceClient::regis ();
			VposOrderQueryOspServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VposOrderQueryOspServiceClient::$DEFAULT_PROXY_IP;
		$port = VposOrderQueryOspServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\fcs\vpos\service\VposOrderQueryOspServiceHelper();
	}
