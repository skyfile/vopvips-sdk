...
class VposTaxOspServiceClient{
	...
	public static function getService(){
		...
		if (! VposTaxOspServiceClient::$isRegis){
			
			VposTaxOspServiceClient::regis ();
			VposTaxOspServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VposTaxOspServiceClient::$DEFAULT_PROXY_IP;
		$port = VposTaxOspServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\fcs\vpos\service\VposTaxOspServiceHelper();
	}
