...
class VendorDiscountDetailRespItem {
	...
	public function getName(){
		...
		return 'VendorDiscountDetailRespItem';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("billDetailReqItem" == $schemeField){
				...
				$this->billDetailReqItem = new \Voop\com\vip\fcs\ap\service\BillAndDiscountDetailReqItem();
			...
			if ("billDetails" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem1 = new \Voop\com\vip\fcs\ap\service\VendorBillDiscountDetail();
						$elem1->read($input);
