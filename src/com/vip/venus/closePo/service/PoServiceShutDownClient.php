...
class PoServiceShutDownClient{
	...
	public static function getService(){
		...
		if (! PoServiceShutDownClient::$isRegis){
			
			PoServiceShutDownClient::regis ();
			PoServiceShutDownClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = PoServiceShutDownClient::$DEFAULT_PROXY_IP;
		$port = PoServiceShutDownClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\venus\closePo\service\PoServiceShutDownHelper();
	}
