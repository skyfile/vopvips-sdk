...
class OfcVopServiceClient{
	...
	public static function getService(){
		...
		if (! OfcVopServiceClient::$isRegis){
			
			OfcVopServiceClient::regis ();
			OfcVopServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = OfcVopServiceClient::$DEFAULT_PROXY_IP;
		$port = OfcVopServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\ofc\OfcVopServiceHelper();
	}
