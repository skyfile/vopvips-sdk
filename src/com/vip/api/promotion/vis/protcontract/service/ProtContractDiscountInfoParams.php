...
class ProtContractDiscountInfoParams {
	...
	public function getName(){
		...
		return 'ProtContractDiscountInfoParams';
	}
			...
			if ("buyAndCutInfos" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem1 = new \Voop\com\vip\api\promotion\vis\protcontract\service\BuyAndCutInfo();
						$elem1->read($input);
						
						$this->buyAndCutInfos[$_size1++] = $elem1;
					}
					catch(\Exception $e){
