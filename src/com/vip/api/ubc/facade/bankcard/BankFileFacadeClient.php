...
class BankFileFacadeClient{
	...
	public static function getService(){
		...
		if (! BankFileFacadeClient::$isRegis){
			
			BankFileFacadeClient::regis ();
			BankFileFacadeClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = BankFileFacadeClient::$DEFAULT_PROXY_IP;
		$port = BankFileFacadeClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\api\ubc\facade\bankcard\BankFileFacadeHelper();
	}
