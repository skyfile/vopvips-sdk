...
class _BankFileFacadeClient extends \Osp\Base\OspStub implements \com\vip\api\ubc\facade\bankcard\BankFileFacadeIf{
	
	public function __construct(){
		
		parent::__construct("com.vip.api.ubc.facade.bankcard.BankFileFacade", "1.0.0");
	}
...
class BankFileFacade_healthCheck_args {
...
class BankFileFacade_receiveBankData_args {
...
class BankFileFacade_receiveBankFile_args {
...
class BankFileFacade_healthCheck_result {
...
class BankFileFacade_receiveBankData_result {
...
class BankFileFacade_receiveBankFile_result {
