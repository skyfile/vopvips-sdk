...
class _XstorePhotoRecordServiceClient extends \Osp\Base\OspStub implements \com\vip\xstore\user\face\service\photorecord\XstorePhotoRecordServiceIf{
	
	public function __construct(){
		
		parent::__construct("com.vip.xstore.user.face.service.photorecord.XstorePhotoRecordService", "1.0.0");
	}
...
class XstorePhotoRecordService_healthCheck_args {
...
class XstorePhotoRecordService_uploadPhotos_args {
...
class XstorePhotoRecordService_healthCheck_result {
...
class XstorePhotoRecordService_uploadPhotos_result {
