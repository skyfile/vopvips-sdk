...
class ReceivingServiceClient{
	...
	public static function getService(){
		...
		if (! ReceivingServiceClient::$isRegis){
			
			ReceivingServiceClient::regis ();
			ReceivingServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ReceivingServiceClient::$DEFAULT_PROXY_IP;
		$port = ReceivingServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\xstore\pda\order\receiving\ReceivingServiceHelper();
	}
