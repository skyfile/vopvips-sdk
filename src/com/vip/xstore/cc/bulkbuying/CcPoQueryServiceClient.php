...
class CcPoQueryServiceClient{
	...
	public static function getService(){
		...
		if (! CcPoQueryServiceClient::$isRegis){
			
			CcPoQueryServiceClient::regis ();
			CcPoQueryServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = CcPoQueryServiceClient::$DEFAULT_PROXY_IP;
		$port = CcPoQueryServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\xstore\cc\bulkbuying\CcPoQueryServiceHelper();
	}
