...
interface XStoreAddressServiceIf{
	...
	public function fixFullAddressData();
	
	public function getTmsAddressByParent( $parentCode);
	
	public function healthCheck();
	
	public function listByCompanyCode( $companyCode);
...
class _XStoreAddressServiceClient extends \Osp\Base\OspStub implements \com\vip\xstore\cc\bulkbuying\service\XStoreAddressServiceIf{
	
	public function __construct(){
		
		parent::__construct("com.vip.xstore.cc.bulkbuying.service.XStoreAddressService", "1.0.0");
	}
	...
	public function fixFullAddressData(){
		...
		$this->send_fixFullAddressData();
		return $this->recv_fixFullAddressData();
	}
	...
	public function getTmsAddressByParent( $parentCode){
		...
		$this->send_getTmsAddressByParent( $parentCode);
		return $this->recv_getTmsAddressByParent();
	}
	...
	public function listByCompanyCode( $companyCode){
		...
		$this->send_listByCompanyCode( $companyCode);
		return $this->recv_listByCompanyCode();
	}
	...
	public function listByIds( $ids){
		...
		$this->send_listByIds( $ids);
		return $this->recv_listByIds();
	}
...
class XStoreAddressService_create_args {
...
class XStoreAddressService_delete_args {
...
class XStoreAddressService_detail_args {
...
class XStoreAddressService_fixFullAddressData_args {
...
class XStoreAddressService_getTmsAddressByParent_args {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['parentCode'])){
				
				$this->parentCode = $vals['parentCode'];
			}
	...
	public function read($input){
		...
		if(true) {
			...
			$input->readString($this->parentCode);
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('parentCode');
		$xfer += $output->writeString($this->parentCode);
...
class XStoreAddressService_healthCheck_args {
...
class XStoreAddressService_listByCompanyCode_args {
...
class XStoreAddressService_listByIds_args {
...
class XStoreAddressService_page_args {
...
class XStoreAddressService_create_result {
...
class XStoreAddressService_delete_result {
...
class XStoreAddressService_detail_result {
...
class XStoreAddressService_fixFullAddressData_result {
...
class XStoreAddressService_getTmsAddressByParent_result {
...
class XStoreAddressService_healthCheck_result {
...
class XStoreAddressService_listByCompanyCode_result {
...
class XStoreAddressService_listByIds_result {
...
class XStoreAddressService_page_result {
