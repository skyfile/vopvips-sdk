...
class PurchaseOrderModelResult {
	...
	public $code = null;
	public $msg = null;
	public $purchaseOrderModelList = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['purchaseOrderModelList'])){
				
				$this->purchaseOrderModelList = $vals['purchaseOrderModelList'];
			}
	...
	public function getName(){
		...
		return 'PurchaseOrderModelResult';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("purchaseOrderModelList" == $schemeField){
				
				$needSkip = false;
				
				$this->purchaseOrderModelList = array();
				$_size0 = 0;
				$input->readListBegin();
				while(true){
	...
	public function write($output){
		...
		if($this->purchaseOrderModelList !== null) {
			
			$xfer += $output->writeFieldBegin('purchaseOrderModelList');
			...
			foreach ($this->purchaseOrderModelList as $iter0){
