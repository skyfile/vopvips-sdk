...
class XStoreAddressPageRes {
	...
	public function write($output){
		...
		if($this->addresses !== null) {
			...
			$xfer += $output->writeFieldBegin('addresses');
			...
			foreach ($this->addresses as $iter0){
