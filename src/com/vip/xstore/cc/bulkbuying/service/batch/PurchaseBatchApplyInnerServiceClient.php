...
class PurchaseBatchApplyInnerServiceClient{
	...
	public static function getService(){
		...
		if (! PurchaseBatchApplyInnerServiceClient::$isRegis){
			
			PurchaseBatchApplyInnerServiceClient::regis ();
			PurchaseBatchApplyInnerServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = PurchaseBatchApplyInnerServiceClient::$DEFAULT_PROXY_IP;
		$port = PurchaseBatchApplyInnerServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\xstore\cc\bulkbuying\service\batch\PurchaseBatchApplyInnerServiceHelper();
	}
