...
class OfcServiceClient{
	...
	public static function getService(){
		...
		if (! OfcServiceClient::$isRegis){
			
			OfcServiceClient::regis ();
			OfcServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = OfcServiceClient::$DEFAULT_PROXY_IP;
		$port = OfcServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\xstore\order\ofc\api\service\OfcServiceHelper();
	}
