...
class GetOfcSyncAfterSaleDataListReq {
	...
	public function getName(){
		...
		return 'GetOfcSyncAfterSaleDataListReq';
	}
	...
	public function write($output){
		...
		if($this->applyIds !== null) {
			...
			$xfer += $output->writeFieldBegin('applyIds');
			...
			$output->writeSetBegin();
			foreach ($this->applyIds as $iter0){
