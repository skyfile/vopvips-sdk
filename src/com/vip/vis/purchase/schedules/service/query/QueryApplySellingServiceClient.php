...
class QueryApplySellingServiceClient{
	...
	public static function getService(){
		...
		if (! QueryApplySellingServiceClient::$isRegis){
			
			QueryApplySellingServiceClient::regis ();
			QueryApplySellingServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = QueryApplySellingServiceClient::$DEFAULT_PROXY_IP;
		$port = QueryApplySellingServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\vis\purchase\schedules\service\query\QueryApplySellingServiceHelper();
	}
