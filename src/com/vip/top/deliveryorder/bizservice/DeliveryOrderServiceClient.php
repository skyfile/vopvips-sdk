...
class DeliveryOrderServiceClient{
	...
	public static function getService(){
		...
		if (! DeliveryOrderServiceClient::$isRegis){
			
			DeliveryOrderServiceClient::regis ();
			DeliveryOrderServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = DeliveryOrderServiceClient::$DEFAULT_PROXY_IP;
		$port = DeliveryOrderServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\top\deliveryorder\bizservice\DeliveryOrderServiceHelper();
	}
