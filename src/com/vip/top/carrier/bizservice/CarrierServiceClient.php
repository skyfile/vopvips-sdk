...
class CarrierServiceClient{
	...
	public static function getService(){
		...
		if (! CarrierServiceClient::$isRegis){
			
			CarrierServiceClient::regis ();
			CarrierServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = CarrierServiceClient::$DEFAULT_PROXY_IP;
		$port = CarrierServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\com\vip\top\carrier\bizservice\CarrierServiceHelper();
	}
