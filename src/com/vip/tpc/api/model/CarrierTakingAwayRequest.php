...
class CarrierTakingAwayRequest {
	...
	public $takingAwayRequests = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['takingAwayRequests'])){
				
				$this->takingAwayRequests = $vals['takingAwayRequests'];
			}
	...
	public function getName(){
		...
		return 'CarrierTakingAwayRequest';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("takingAwayRequests" == $schemeField){
				
				$needSkip = false;
				
				$this->takingAwayRequests = array();
				$_size1 = 0;
				$input->readListBegin();
				while(true){
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('takingAwayRequests');
		...
		foreach ($this->takingAwayRequests as $iter0){
