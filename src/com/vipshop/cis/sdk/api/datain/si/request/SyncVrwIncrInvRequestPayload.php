...
class SyncVrwIncrInvRequestPayload {
	...
	public function getName(){
		...
		return 'SyncVrwIncrInvRequestPayload';
	}
			...
			if ("data_list" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem1 = new \Voop\com\vipshop\cis\sdk\api\datain\si\request\SyncVrwIncrInvRequestPayloadItem();
						$elem1->read($input);
						
						$this->data_list[$_size1++] = $elem1;
					}
					catch(\Exception $e){
