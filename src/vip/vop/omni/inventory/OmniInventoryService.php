...
class _OmniInventoryServiceClient extends \Voop\Osp\Base\OspStub implements \vip\vop\omni\inventory\OmniInventoryServiceIf{
	...
	public function __construct(){
		...
		parent::__construct("vip.vop.omni.inventory.OmniInventoryService", "1.0.0");
	}
...
class OmniInventoryService_healthCheck_args {
...
class OmniInventoryService_updateStoreInventory_args {
...
class OmniInventoryService_updateStoreInventory4Inner_args {
...
class OmniInventoryService_healthCheck_result {
...
class OmniInventoryService_updateStoreInventory_result {
...
class OmniInventoryService_updateStoreInventory4Inner_result {
