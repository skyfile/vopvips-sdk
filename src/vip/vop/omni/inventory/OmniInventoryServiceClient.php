...
class OmniInventoryServiceClient{
	...
	public static function getService(){
		...
		if (! OmniInventoryServiceClient::$isRegis){
			
			OmniInventoryServiceClient::regis ();
			OmniInventoryServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = OmniInventoryServiceClient::$DEFAULT_PROXY_IP;
		$port = OmniInventoryServiceClient::$DEFAULT_PROXY_PORT;	
		try{
