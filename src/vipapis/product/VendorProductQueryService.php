...
interface VendorProductQueryServiceIf{
	...
	public function queryByBarcode( $vendor_id, $barcode, $source);
	
	public function queryByBrandAndSn( $vendor_id, $brand_id, $sn, $source);
	
}

class _VendorProductQueryServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\product\VendorProductQueryServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.product.VendorProductQueryService", "1.0.0");
	}
	...
	public function queryByBarcode( $vendor_id, $barcode, $source){
		...
		$this->send_queryByBarcode( $vendor_id, $barcode, $source);
		return $this->recv_queryByBarcode();
	}
	...
	public function queryByBrandAndSn( $vendor_id, $brand_id, $sn, $source){
		...
		$this->send_queryByBrandAndSn( $vendor_id, $brand_id, $sn, $source);
		return $this->recv_queryByBrandAndSn();
	}
...
class VendorProductQueryService_healthCheck_args {
...
class VendorProductQueryService_queryByBarcode_args {
...
class VendorProductQueryService_queryByBrandAndSn_args {
...
class VendorProductQueryService_healthCheck_result {
...
class VendorProductQueryService_queryByBarcode_result {
...
class VendorProductQueryService_queryByBrandAndSn_result {
