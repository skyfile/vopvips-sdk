...
class EditVendorProductItem {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['size_table_prop'])){
				
				$this->size_table_prop = $vals['size_table_prop'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("size_table_prop" == $schemeField){
	...
	public function write($output){
		...
		if($this->size_table_prop !== null) {
			
			$xfer += $output->writeFieldBegin('size_table_prop');
