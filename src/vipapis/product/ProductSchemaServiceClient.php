...
class ProductSchemaServiceClient{
	...
	public static function getService(){
		...
		if (! ProductSchemaServiceClient::$isRegis){
			
			ProductSchemaServiceClient::regis ();
			ProductSchemaServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ProductSchemaServiceClient::$DEFAULT_PROXY_IP;
		$port = ProductSchemaServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\product\ProductSchemaServiceHelper();
	}
