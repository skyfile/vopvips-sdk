...
class VendorProductServiceClient{
	...
	public static function getService(){
		...
		if (! VendorProductServiceClient::$isRegis){
			
			VendorProductServiceClient::regis ();
			VendorProductServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VendorProductServiceClient::$DEFAULT_PROXY_IP;
		$port = VendorProductServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\product\VendorProductServiceHelper();
	}
