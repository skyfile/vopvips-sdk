...
interface ChannelProductServiceIf{
	...
	public function getHtProductList( $type, $page);
	
	public function healthCheck();
	
}

class _ChannelProductServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\product\ChannelProductServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.product.ChannelProductService", "1.0.0");
	}
	
	
	public function getHtProductList( $type, $page){
		
		$this->send_getHtProductList( $type, $page);
		return $this->recv_getHtProductList();
	}
...
class ChannelProductService_getHtProductList_args {
...
class ChannelProductService_healthCheck_args {
...
class ChannelProductService_getHtProductList_result {
...
class ChannelProductService_healthCheck_result {
