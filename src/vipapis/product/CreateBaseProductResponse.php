...
class CreateBaseProductResponse {
	...
	public function getName(){
		...
		return 'CreateBaseProductResponse';
	}
			...
			if ("success_list" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem0 = new \Voop\vipapis\product\CreateBaseProductResult();
						$elem0->read($input);
			...
			if ("failed_list" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem1 = new \Voop\vipapis\product\CreateBaseProductResult();
						$elem1->read($input);
