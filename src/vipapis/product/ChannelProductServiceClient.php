...
class ChannelProductServiceClient{
	...
	public static function getService(){
		...
		if (! ChannelProductServiceClient::$isRegis){
			
			ChannelProductServiceClient::regis ();
			ChannelProductServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ChannelProductServiceClient::$DEFAULT_PROXY_IP;
		$port = ChannelProductServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\product\ChannelProductServiceHelper();
	}
