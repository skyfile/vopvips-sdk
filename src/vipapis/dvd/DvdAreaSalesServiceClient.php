...
class DvdAreaSalesServiceClient{
	...
	public static function getService(){
		...
		if (! DvdAreaSalesServiceClient::$isRegis){
			
			DvdAreaSalesServiceClient::regis ();
			DvdAreaSalesServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = DvdAreaSalesServiceClient::$DEFAULT_PROXY_IP;
		$port = DvdAreaSalesServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\dvd\DvdAreaSalesServiceHelper();
	}
