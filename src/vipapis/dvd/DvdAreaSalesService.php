...
class _DvdAreaSalesServiceClient extends \Osp\Base\OspStub implements \vipapis\dvd\DvdAreaSalesServiceIf{
	...
	public function __construct(){
		...
		parent::__construct("vipapis.dvd.DvdAreaSalesService", "1.0.0");
	}
	...
	public function getAreaWarehouse( $vendor_id){
		...
		$this->send_getAreaWarehouse( $vendor_id);
		return $this->recv_getAreaWarehouse();
	}
...
class DvdAreaSalesService_getAreaOccupiedOrders_args {
...
class DvdAreaSalesService_getAreaWarehouse_args {
...
class DvdAreaSalesService_healthCheck_args {
...
class DvdAreaSalesService_getAreaOccupiedOrders_result {
...
class DvdAreaSalesService_getAreaWarehouse_result {
...
class DvdAreaSalesService_healthCheck_result {
