...
interface StoreSizeTableServiceIf{
	...
	public function deleteSizeTableTemplate( $size_table_template_id);
...
class _StoreSizeTableServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\marketplace\sizetable\StoreSizeTableServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.marketplace.sizetable.StoreSizeTableService", "1.0.0");
	}
	...
	public function batchGetSizeDetails( $size_detail_ids){
		...
		$this->send_batchGetSizeDetails( $size_detail_ids);
		return $this->recv_batchGetSizeDetails();
	}
	...
	public function deleteSizeTableTemplate( $size_table_template_id){
		...
		$this->send_deleteSizeTableTemplate( $size_table_template_id);
	...
	public function getSizeTable( $size_table_id){
		...
		$this->send_getSizeTable( $size_table_id);
		return $this->recv_getSizeTable();
	}
	...
	public function getTemplateTypes( $template_types){
		...
		$this->send_getTemplateTypes( $template_types);
		return $this->recv_getTemplateTypes();
	}
...
class StoreSizeTableService_addSizeDetail_args {
...
class StoreSizeTableService_addSizeTable_args {
...
class StoreSizeTableService_addSizeTableTemplate_args {
...
class StoreSizeTableService_batchGetSizeDetails_args {
	
	static $_TSPEC;
	public $size_detail_ids = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['size_detail_ids'])){
				
				$this->size_detail_ids = $vals['size_detail_ids'];
			}
		...
		if(true) {
			...
			while(true){
				...
				try{
					...
					$this->size_detail_ids[$_size0++] = $elem0;
				}
				catch(\Exception $e){
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('size_detail_ids');
		...
		foreach ($this->size_detail_ids as $iter0){
...
class StoreSizeTableService_deleteSizeTableTemplate_args {
...
class StoreSizeTableService_getSizeTable_args {
...
class StoreSizeTableService_getSizeTableTemplate_args {
...
class StoreSizeTableService_getTemplateTypes_args {
		...
		if(true) {
			...
			while(true){
				...
				try{
					...
					$this->template_types[$_size0++] = $elem0;
				}
				catch(\Exception $e){
...
class StoreSizeTableService_healthCheck_args {
...
class StoreSizeTableService_updateSizeDetail_args {
...
class StoreSizeTableService_updateSizeTable_args {
...
class StoreSizeTableService_addSizeDetail_result {
...
class StoreSizeTableService_addSizeTable_result {
...
class StoreSizeTableService_addSizeTableTemplate_result {
...
class StoreSizeTableService_batchGetSizeDetails_result {
...
class StoreSizeTableService_deleteSizeTableTemplate_result {
...
class StoreSizeTableService_getSizeTable_result {
...
class StoreSizeTableService_getSizeTableTemplate_result {
...
class StoreSizeTableService_getTemplateTypes_result {
...
class StoreSizeTableService_healthCheck_result {
...
class StoreSizeTableService_updateSizeDetail_result {
...
class StoreSizeTableService_updateSizeTable_result {
