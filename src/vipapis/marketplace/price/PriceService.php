...
interface PriceServiceIf{
	...
	public function getSkuPrice( $sku_id);
	
	public function healthCheck();
	
	public function updateSkuPrice( $sku_id, $market_price, $sale_price);
...
class _PriceServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\marketplace\price\PriceServiceIf{
	...
	public function __construct(){
		...
		parent::__construct("vipapis.marketplace.price.PriceService", "1.0.0");
	}
	...
	public function send_updateSkuPrice( $sku_id, $market_price, $sale_price){
		...
		$args->market_price = $market_price;
...
class PriceService_getSkuPrice_args {
...
class PriceService_updateSkuPrice_args {
...
class PriceService_getSkuPrice_result {
...
class PriceService_updateSkuPrice_result {
