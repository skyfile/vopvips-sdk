...
class StoreBrandServiceClient{
	...
	public static function getService(){
		...
		if (! StoreBrandServiceClient::$isRegis){
			
			StoreBrandServiceClient::regis ();
			StoreBrandServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = StoreBrandServiceClient::$DEFAULT_PROXY_IP;
		$port = StoreBrandServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\marketplace\brand\StoreBrandServiceHelper();
	}
