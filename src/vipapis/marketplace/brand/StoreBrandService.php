...
class _StoreBrandServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\marketplace\brand\StoreBrandServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.marketplace.brand.StoreBrandService", "1.0.0");
	}
	
	
	public function getStoreBrands(){
		
		$this->send_getStoreBrands();
		return $this->recv_getStoreBrands();
	}
...
class StoreBrandService_getStoreBrands_args {
...
class StoreBrandService_healthCheck_args {
...
class StoreBrandService_getStoreBrands_result {
...
class StoreBrandService_healthCheck_result {
