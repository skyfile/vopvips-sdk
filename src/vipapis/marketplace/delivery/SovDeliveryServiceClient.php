...
class SovDeliveryServiceClient{
	...
	public static function getService(){
		...
		if (! SovDeliveryServiceClient::$isRegis){
			
			SovDeliveryServiceClient::regis ();
			SovDeliveryServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = SovDeliveryServiceClient::$DEFAULT_PROXY_IP;
		$port = SovDeliveryServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\marketplace\delivery\SovDeliveryServiceHelper();
	}
