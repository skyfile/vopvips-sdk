...
class JDProductServiceClient{
	...
	public static function getService(){
		...
		if (! JDProductServiceClient::$isRegis){
			
			JDProductServiceClient::regis ();
			JDProductServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = JDProductServiceClient::$DEFAULT_PROXY_IP;
		$port = JDProductServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\marketplace\jingdong\JDProductServiceHelper();
	}
