...
interface JDProductServiceIf{
	...
	public function skuOffShelf( $sku_id);
	
	public function skuOnShelf( $sku_id);
	
}

class _JDProductServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\marketplace\jingdong\JDProductServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.marketplace.jingdong.JDProductService", "1.0.0");
	}
	...
	public function getSkuCommission( $sku_ids){
		...
		$this->send_getSkuCommission( $sku_ids);
		return $this->recv_getSkuCommission();
	}
	...
	public function skuOffShelf( $sku_id){
		...
		$this->send_skuOffShelf( $sku_id);
		return $this->recv_skuOffShelf();
	}
	...
	public function skuOnShelf( $sku_id){
		...
		$this->send_skuOnShelf( $sku_id);
		return $this->recv_skuOnShelf();
	}
...
class JDProductService_getOrderActive_args {
...
class JDProductService_getSkuCommission_args {
...
class JDProductService_healthCheck_args {
...
class JDProductService_skuOffShelf_args {
...
class JDProductService_skuOnShelf_args {
...
class JDProductService_getOrderActive_result {
...
class JDProductService_getSkuCommission_result {
...
class JDProductService_healthCheck_result {
...
class JDProductService_skuOffShelf_result {
...
class JDProductService_skuOnShelf_result {
