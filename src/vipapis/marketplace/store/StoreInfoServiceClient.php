...
class StoreInfoServiceClient{
	...
	public static function getService(){
		...
		if (! StoreInfoServiceClient::$isRegis){
			
			StoreInfoServiceClient::regis ();
			StoreInfoServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = StoreInfoServiceClient::$DEFAULT_PROXY_IP;
		$port = StoreInfoServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\marketplace\store\StoreInfoServiceHelper();
	}
