...
class _StoreInfoServiceClient extends \Osp\Base\OspStub implements \vipapis\marketplace\store\StoreInfoServiceIf{
	...
	public function __construct(){
		...
		parent::__construct("vipapis.marketplace.store.StoreInfoService", "1.0.0");
	}
	
	
	public function getStoreInfo(){
		
		$this->send_getStoreInfo();
		return $this->recv_getStoreInfo();
	}
	...
	public function getWarehouse(){
		...
		$this->send_getWarehouse();
		return $this->recv_getWarehouse();
	}
...
class StoreInfoService_getStoreInfo_args {
...
class StoreInfoService_getWarehouse_args {
...
class StoreInfoService_healthCheck_args {
...
class StoreInfoService_getStoreInfo_result {
...
class StoreInfoService_getWarehouse_result {
...
class StoreInfoService_healthCheck_result {
