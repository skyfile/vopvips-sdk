...
class _CategoryServiceClient extends \Osp\Base\OspStub implements \vipapis\marketplace\category\CategoryServiceIf{
	...
	public function __construct(){
		...
		parent::__construct("vipapis.marketplace.category.CategoryService", "1.0.0");
	}
	
	
	public function getStoreCategories(){
		
		$this->send_getStoreCategories();
		return $this->recv_getStoreCategories();
	}
...
class CategoryService_getStoreCategories_args {
...
class CategoryService_getStoreCategories_result {
