...
class CategoryServiceClient{
	...
	public static function getService(){
		...
		if (! CategoryServiceClient::$isRegis){
			
			CategoryServiceClient::regis ();
			CategoryServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = CategoryServiceClient::$DEFAULT_PROXY_IP;
		$port = CategoryServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\marketplace\category\CategoryServiceHelper();
	}
