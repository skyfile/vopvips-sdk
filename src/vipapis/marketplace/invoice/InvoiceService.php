...
class _InvoiceServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\marketplace\invoice\InvoiceServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.marketplace.invoice.InvoiceService", "1.0.0");
	}
...
class InvoiceService_confirmInvoice_args {
...
class InvoiceService_getInvoices_args {
...
class InvoiceService_healthCheck_args {
...
class InvoiceService_confirmInvoice_result {
...
class InvoiceService_getInvoices_result {
...
class InvoiceService_healthCheck_result {
