...
class OutWmsServiceClient{
	...
	public static function getService(){
		...
		if (! OutWmsServiceClient::$isRegis){
			
			OutWmsServiceClient::regis ();
			OutWmsServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = OutWmsServiceClient::$DEFAULT_PROXY_IP;
		$port = OutWmsServiceClient::$DEFAULT_PROXY_PORT;	
		try{
