...
class VendorSizeMappingServiceClient{
	...
	public static function getService(){
		...
		if (! VendorSizeMappingServiceClient::$isRegis){
			
			VendorSizeMappingServiceClient::regis ();
			VendorSizeMappingServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VendorSizeMappingServiceClient::$DEFAULT_PROXY_IP;
		$port = VendorSizeMappingServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\size\VendorSizeMappingServiceHelper();
	}
