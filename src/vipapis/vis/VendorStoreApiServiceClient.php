...
class VendorStoreApiServiceClient{
	...
	public static function getService(){
		...
		if (! VendorStoreApiServiceClient::$isRegis){
			
			VendorStoreApiServiceClient::regis ();
			VendorStoreApiServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VendorStoreApiServiceClient::$DEFAULT_PROXY_IP;
		$port = VendorStoreApiServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\vis\VendorStoreApiServiceHelper();
	}
