...
class VendorSizeTableServiceClient{
	...
	public static function getService(){
		...
		if (! VendorSizeTableServiceClient::$isRegis){
			
			VendorSizeTableServiceClient::regis ();
			VendorSizeTableServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VendorSizeTableServiceClient::$DEFAULT_PROXY_IP;
		$port = VendorSizeTableServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\vsizetable\VendorSizeTableServiceHelper();
	}
