...
class _CarrierLogisticTrackServiceClient extends \Osp\Base\OspStub implements \vipapis\track\service\CarrierLogisticTrackServiceIf{
	...
	public function __construct(){
		...
		parent::__construct("vipapis.track.service.CarrierLogisticTrackService", "1.0.0");
	}
...
class CarrierLogisticTrackService_acceptLogisticsTrack_args {
...
class CarrierLogisticTrackService_healthCheck_args {
...
class CarrierLogisticTrackService_acceptLogisticsTrack_result {
...
class CarrierLogisticTrackService_healthCheck_result {
