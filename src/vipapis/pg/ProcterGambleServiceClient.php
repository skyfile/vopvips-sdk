...
class ProcterGambleServiceClient{
	...
	public static function getService(){
		...
		if (! ProcterGambleServiceClient::$isRegis){
			
			ProcterGambleServiceClient::regis ();
			ProcterGambleServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ProcterGambleServiceClient::$DEFAULT_PROXY_IP;
		$port = ProcterGambleServiceClient::$DEFAULT_PROXY_PORT;	
		try{
