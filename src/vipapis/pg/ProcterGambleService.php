...
class _ProcterGambleServiceClient extends \Osp\Base\OspStub implements \vipapis\pg\ProcterGambleServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.pg.ProcterGambleService", "1.0.0");
	}
...
class ProcterGambleService_getGoods_args {
...
class ProcterGambleService_getGoodsStock_args {
...
class ProcterGambleService_getOrders_args {
...
class ProcterGambleService_healthCheck_args {
...
class ProcterGambleService_getGoods_result {
...
class ProcterGambleService_getGoodsStock_result {
...
class ProcterGambleService_getOrders_result {
...
class ProcterGambleService_healthCheck_result {
