...
class TrusteeshipInfoServiceClient{
	...
	public static function getService(){
		...
		if (! TrusteeshipInfoServiceClient::$isRegis){
			
			TrusteeshipInfoServiceClient::regis ();
			TrusteeshipInfoServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = TrusteeshipInfoServiceClient::$DEFAULT_PROXY_IP;
		$port = TrusteeshipInfoServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\fcs\TrusteeshipInfoServiceHelper();
	}
