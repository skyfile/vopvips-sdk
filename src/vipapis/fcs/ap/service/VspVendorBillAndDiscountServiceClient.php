...
class VspVendorBillAndDiscountServiceClient{
	...
	public static function getService(){
		...
		if (! VspVendorBillAndDiscountServiceClient::$isRegis){
			
			VspVendorBillAndDiscountServiceClient::regis ();
			VspVendorBillAndDiscountServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VspVendorBillAndDiscountServiceClient::$DEFAULT_PROXY_IP;
		$port = VspVendorBillAndDiscountServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\fcs\ap\service\VspVendorBillAndDiscountServiceHelper();
	}
