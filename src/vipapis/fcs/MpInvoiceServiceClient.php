...
class MpInvoiceServiceClient{
	...
	public static function getService(){
		...
		if (! MpInvoiceServiceClient::$isRegis){
			
			MpInvoiceServiceClient::regis ();
			MpInvoiceServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = MpInvoiceServiceClient::$DEFAULT_PROXY_IP;
		$port = MpInvoiceServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\fcs\MpInvoiceServiceHelper();
	}
