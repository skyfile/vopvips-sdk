...
class VipCardServiceClient{
	...
	public static function getService(){
		...
		if (! VipCardServiceClient::$isRegis){
			
			VipCardServiceClient::regis ();
			VipCardServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VipCardServiceClient::$DEFAULT_PROXY_IP;
		$port = VipCardServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\vipcard\VipCardServiceHelper();
	}
