...
class OmniOrderServiceClient{
	...
	public static function getService(){
		...
		if (! OmniOrderServiceClient::$isRegis){
			
			OmniOrderServiceClient::regis ();
			OmniOrderServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = OmniOrderServiceClient::$DEFAULT_PROXY_IP;
		$port = OmniOrderServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\order\OmniOrderServiceHelper();
	}
