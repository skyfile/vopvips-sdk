...
class WopOrderServiceClient{
	...
	public static function getService(){
		...
		if (! WopOrderServiceClient::$isRegis){
			
			WopOrderServiceClient::regis ();
			WopOrderServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = WopOrderServiceClient::$DEFAULT_PROXY_IP;
		$port = WopOrderServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\order\WopOrderServiceHelper();
	}
