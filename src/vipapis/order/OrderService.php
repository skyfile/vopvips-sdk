...
interface OrderServiceIf{
	...
	public function getChannelOrderList( $channel_id, $order_sn);
	
	public function healthCheck();
	
}

class _OrderServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\order\OrderServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.order.OrderService", "1.0.0");
	}
	
	
	public function getChannelOrderList( $channel_id, $order_sn){
		
		$this->send_getChannelOrderList( $channel_id, $order_sn);
		return $this->recv_getChannelOrderList();
	}
...
class OrderService_getChannelOrderList_args {
	...
	public function write($output){
		...
		foreach ($this->order_sn as $iter0){
...
class OrderService_getChannelOrderList_result {
