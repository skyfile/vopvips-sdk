...
class ScheduleProductResponse {
	...
	public function getName(){
		...
		return 'ScheduleProductResponse';
	}
	...
	public function write($output){
		...
		if($this->productList !== null) {
			...
			$xfer += $output->writeFieldBegin('productList');
			...
			foreach ($this->productList as $iter0){
