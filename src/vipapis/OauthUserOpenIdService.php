...
namespace vipapis;
interface OauthUserOpenIdServiceIf{
...
class _OauthUserOpenIdServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\OauthUserOpenIdServiceIf{
	...
	public function __construct(){
		...
		parent::__construct("vipapis.OauthUserOpenIdService", "1.0.0");
	}
	
	
	public function getOpenIdByUserId( $userId){
		
		$this->send_getOpenIdByUserId( $userId);
		return $this->recv_getOpenIdByUserId();
	}
	...
	public function getUserIdByOpenId( $openId){
		...
		$this->send_getUserIdByOpenId( $openId);
		return $this->recv_getUserIdByOpenId();
	}
...
class OauthUserOpenIdService_getOpenIdByUserId_args {
...
class OauthUserOpenIdService_getUserIdByOpenId_args {
...
class OauthUserOpenIdService_healthCheck_args {
...
class OauthUserOpenIdService_getOpenIdByUserId_result {
...
class OauthUserOpenIdService_getUserIdByOpenId_result {
...
class OauthUserOpenIdService_healthCheck_result {
