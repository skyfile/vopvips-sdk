...
class _JitDeliveryServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\delivery\JitDeliveryServiceIf{
	...
	public function createPick( $po_no, $vendor_id, $co_mode, $warehouse, $store_sn, $pick_flag){
		...
		$this->send_createPick( $po_no, $vendor_id, $co_mode, $warehouse, $store_sn, $pick_flag);
...
class JitDeliveryService_cancelDelivery_args {
	
	static $_TSPEC;
	public $cancelDeliveryReq = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['cancelDeliveryReq'])){
				
				$this->cancelDeliveryReq = $vals['cancelDeliveryReq'];
			}
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('cancelDeliveryReq');
...
class JitDeliveryService_createPoDeliveryV2_args {
	
	static $_TSPEC;
	public $createPoDeliveryReq = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['createPoDeliveryReq'])){
				
				$this->createPoDeliveryReq = $vals['createPoDeliveryReq'];
			}
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('createPoDeliveryReq');
...
class JitDeliveryService_editPoDeliveryV2_args {
	
	static $_TSPEC;
	public $editDeliveryReq = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['editDeliveryReq'])){
				
				$this->editDeliveryReq = $vals['editDeliveryReq'];
			}
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('editDeliveryReq');
...
class JitDeliveryService_cancelDelivery_result {
...
class JitDeliveryService_createPoDeliveryV2_result {
...
class JitDeliveryService_editPoDeliveryV2_result {
