...
class GetCarrierListResponse {
			...
			if ("carriers" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem0 = new \Voop\vipapis\delivery\Carrier();
						$elem0->read($input);
						
						$this->carriers[$_size0++] = $elem0;
					}
					catch(\Exception $e){
	...
	public function write($output){
		...
		if($this->carriers !== null) {
			...
			$xfer += $output->writeFieldBegin('carriers');
			...
			foreach ($this->carriers as $iter0){
