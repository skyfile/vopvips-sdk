...
class GetReturnListResponse {
	...
	public function read($input){
		...
		while(true){
			...
			if ("dvd_return_list" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem0 = new \Voop\vipapis\delivery\DvdReturn();
						$elem0->read($input);
						
						$this->dvd_return_list[$_size0++] = $elem0;
					}
					catch(\Exception $e){
