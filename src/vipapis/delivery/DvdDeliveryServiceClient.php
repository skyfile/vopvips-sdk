...
class DvdDeliveryServiceClient{
	...
	public static function getService(){
		...
		if (! DvdDeliveryServiceClient::$isRegis){
			
			DvdDeliveryServiceClient::regis ();
			DvdDeliveryServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = DvdDeliveryServiceClient::$DEFAULT_PROXY_IP;
		$port = DvdDeliveryServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\delivery\DvdDeliveryServiceHelper();
	}
