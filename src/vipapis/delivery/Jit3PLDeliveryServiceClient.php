...
class Jit3PLDeliveryServiceClient{
	...
	public static function getService(){
		...
		if (! Jit3PLDeliveryServiceClient::$isRegis){
			
			Jit3PLDeliveryServiceClient::regis ();
			Jit3PLDeliveryServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = Jit3PLDeliveryServiceClient::$DEFAULT_PROXY_IP;
		$port = Jit3PLDeliveryServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\delivery\Jit3PLDeliveryServiceHelper();
	}
