...
class JitDeliveryServiceClient{
	...
	public static function getService(){
		...
		if (! JitDeliveryServiceClient::$isRegis){
			
			JitDeliveryServiceClient::regis ();
			JitDeliveryServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = JitDeliveryServiceClient::$DEFAULT_PROXY_IP;
		$port = JitDeliveryServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\delivery\JitDeliveryServiceHelper();
	}
