...
class ProductCommonServiceClient{
	...
	public static function getService(){
		...
		if (! ProductCommonServiceClient::$isRegis){
			
			ProductCommonServiceClient::regis ();
			ProductCommonServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ProductCommonServiceClient::$DEFAULT_PROXY_IP;
		$port = ProductCommonServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\common\ProductCommonServiceHelper();
	}
