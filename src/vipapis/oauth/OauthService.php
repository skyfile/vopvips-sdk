...
class _OauthServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\oauth\OauthServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.oauth.OauthService", "1.0.0");
	}
...
class OauthService_healthCheck_args {
...
class OauthService_refreshToken_args {
...
class OauthService_healthCheck_result {
...
class OauthService_refreshToken_result {
