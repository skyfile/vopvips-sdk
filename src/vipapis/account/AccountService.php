...
class _AccountServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\account\AccountServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.account.AccountService", "1.0.0");
	}
...
class AccountService_getEnterpriseAccounts_args {
...
class AccountService_getEnterpriseOrders_args {
...
class AccountService_healthCheck_args {
...
class AccountService_updateEnterpriseAccount_args {
...
class AccountService_updateEnterpriseAccounts_args {
...
class AccountService_getEnterpriseAccounts_result {
...
class AccountService_getEnterpriseOrders_result {
...
class AccountService_healthCheck_result {
...
class AccountService_updateEnterpriseAccount_result {
...
class AccountService_updateEnterpriseAccounts_result {
