...
class AccountServiceClient{
	...
	public static function getService(){
		...
		if (! AccountServiceClient::$isRegis){
			
			AccountServiceClient::regis ();
			AccountServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = AccountServiceClient::$DEFAULT_PROXY_IP;
		$port = AccountServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\account\AccountServiceHelper();
	}
