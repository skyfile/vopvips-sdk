...
class RetransmitServiceClient{
	...
	public static function getService(){
		...
		if (! RetransmitServiceClient::$isRegis){
			
			RetransmitServiceClient::regis ();
			RetransmitServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = RetransmitServiceClient::$DEFAULT_PROXY_IP;
		$port = RetransmitServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\informal\RetransmitServiceHelper();
	}
