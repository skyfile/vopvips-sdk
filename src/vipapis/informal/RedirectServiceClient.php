...
class RedirectServiceClient{
	...
	public static function getService(){
		...
		if (! RedirectServiceClient::$isRegis){
			
			RedirectServiceClient::regis ();
			RedirectServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = RedirectServiceClient::$DEFAULT_PROXY_IP;
		$port = RedirectServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\informal\RedirectServiceHelper();
	}
