...
class VendorStoreServiceClient{
	...
	public static function getService(){
		...
		if (! VendorStoreServiceClient::$isRegis){
			
			VendorStoreServiceClient::regis ();
			VendorStoreServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VendorStoreServiceClient::$DEFAULT_PROXY_IP;
		$port = VendorStoreServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\store\VendorStoreServiceHelper();
	}
