...
class OWarehouseServiceClient{
	...
	public static function getService(){
		...
		if (! OWarehouseServiceClient::$isRegis){
			
			OWarehouseServiceClient::regis ();
			OWarehouseServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = OWarehouseServiceClient::$DEFAULT_PROXY_IP;
		$port = OWarehouseServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\overseas\OWarehouseServiceHelper();
	}
