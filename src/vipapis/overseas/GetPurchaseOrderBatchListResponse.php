...
class GetPurchaseOrderBatchListResponse {
	...
	public function getName(){
		...
		return 'GetPurchaseOrderBatchListResponse';
	}
			...
			if ("po_batch_list" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem1 = new \Voop\vipapis\overseas\PurchaseOrderBatchInfo();
						$elem1->read($input);
