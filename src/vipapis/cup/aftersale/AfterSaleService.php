...
interface AfterSaleServiceIf{
	...
	public function createReturnApply( $req_list);
	
	public function getReturnApplyStatus( $start_time, $end_time, $page, $page_size);
	
	public function healthCheck();
	
	public function updateReturnApplyStatus( $req_list);
	
	public function updateReturnRefundResult( $req_list);
	
}

class _AfterSaleServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\cup\aftersale\AfterSaleServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.cup.aftersale.AfterSaleService", "1.0.0");
	}
	
	
	public function createReturnApply( $req_list){
		
		$this->send_createReturnApply( $req_list);
	...
	public function getReturnApplyStatus( $start_time, $end_time, $page, $page_size){
		...
		$this->send_getReturnApplyStatus( $start_time, $end_time, $page, $page_size);
		return $this->recv_getReturnApplyStatus();
	}
	...
	public function updateReturnApplyStatus( $req_list){
		...
		$this->send_updateReturnApplyStatus( $req_list);
		return $this->recv_updateReturnApplyStatus();
	}
	...
	public function updateReturnRefundResult( $req_list){
		...
		$this->send_updateReturnRefundResult( $req_list);
		return $this->recv_updateReturnRefundResult();
	}
...
class AfterSaleService_createReturnApply_args {
	
	static $_TSPEC;
	public $req_list = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['req_list'])){
				
				$this->req_list = $vals['req_list'];
			}
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('req_list');
		...
		foreach ($this->req_list as $iter0){
...
class AfterSaleService_getReturnApplyStatus_args {
...
class AfterSaleService_healthCheck_args {
...
class AfterSaleService_updateReturnApplyStatus_args {
...
class AfterSaleService_updateReturnRefundResult_args {
...
class AfterSaleService_createReturnApply_result {
...
class AfterSaleService_getReturnApplyStatus_result {
...
class AfterSaleService_healthCheck_result {
...
class AfterSaleService_updateReturnApplyStatus_result {
...
class AfterSaleService_updateReturnRefundResult_result {
