...
class ProductServiceClient{
	...
	public static function getService(){
		...
		if (! ProductServiceClient::$isRegis){
			
			ProductServiceClient::regis ();
			ProductServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ProductServiceClient::$DEFAULT_PROXY_IP;
		$port = ProductServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\cup\product\ProductServiceHelper();
	}
