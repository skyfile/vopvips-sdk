...
class AddressServiceClient{
	...
	public static function getService(){
		...
		if (! AddressServiceClient::$isRegis){
			
			AddressServiceClient::regis ();
			AddressServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = AddressServiceClient::$DEFAULT_PROXY_IP;
		$port = AddressServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\cup\address\AddressServiceHelper();
	}
