...
class OauthUserOpenIdServiceClient{
	...
	public static function getService(){
		...
		if (! OauthUserOpenIdServiceClient::$isRegis){
			
			OauthUserOpenIdServiceClient::regis ();
			OauthUserOpenIdServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = OauthUserOpenIdServiceClient::$DEFAULT_PROXY_IP;
		$port = OauthUserOpenIdServiceClient::$DEFAULT_PROXY_PORT;	
		try{
