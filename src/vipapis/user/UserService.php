...
class _UserServiceClient extends \Osp\Base\OspStub implements \vipapis\user\UserServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.user.UserService", "1.0.0");
	}
...
class UserService_getGroups_args {
...
class UserService_getUsersByGroupCode_args {
...
class UserService_getGroups_result {
...
class UserService_getUsersByGroupCode_result {
