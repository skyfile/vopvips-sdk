...
class _OrderServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\vipmax\order\OrderServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.vipmax.order.OrderService", "1.0.0");
	}
...
class OrderService_getVipmaxOders_args {
...
class OrderService_syncOrder_args {
...
class OrderService_syncRefundOrder_args {
...
class OrderService_getVipmaxOders_result {
...
class OrderService_syncOrder_result {
...
class OrderService_syncRefundOrder_result {
