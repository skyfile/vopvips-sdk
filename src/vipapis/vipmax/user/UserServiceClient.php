...
class UserServiceClient{
	...
	public static function getService(){
		...
		if (! UserServiceClient::$isRegis){
			
			UserServiceClient::regis ();
			UserServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = UserServiceClient::$DEFAULT_PROXY_IP;
		$port = UserServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\vipmax\user\UserServiceHelper();
	}
