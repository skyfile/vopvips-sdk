...
class _UserServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\vipmax\user\UserServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.vipmax.user.UserService", "1.0.0");
	}
...
class UserService_getUserInfo_args {
	...
	static $_TSPEC;
	public $getUserInfoRequest = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['getUserInfoRequest'])){
				
				$this->getUserInfoRequest = $vals['getUserInfoRequest'];
			}
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('getUserInfoRequest');
...
class UserService_healthCheck_args {
...
class UserService_healthCheck_result {
