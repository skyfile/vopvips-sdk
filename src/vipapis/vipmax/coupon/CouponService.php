...
class _CouponServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\vipmax\coupon\CouponServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.vipmax.coupon.CouponService", "1.0.0");
	}
...
class CouponService_checkCouponInfo_args {
...
class CouponService_healthCheck_args {
...
class CouponService_returnCoupon_args {
...
class CouponService_rollbackUseCoupon_args {
...
class CouponService_submitCouponInfo_args {
...
class CouponService_checkCouponInfo_result {
...
class CouponService_healthCheck_result {
...
class CouponService_returnCoupon_result {
...
class CouponService_rollbackUseCoupon_result {
...
class CouponService_submitCouponInfo_result {
