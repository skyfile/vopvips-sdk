...
class CommentCustServiceClient{
	...
	public static function getService(){
		...
		if (! CommentCustServiceClient::$isRegis){
			
			CommentCustServiceClient::regis ();
			CommentCustServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = CommentCustServiceClient::$DEFAULT_PROXY_IP;
		$port = CommentCustServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\logistical\CommentCustServiceHelper();
	}
