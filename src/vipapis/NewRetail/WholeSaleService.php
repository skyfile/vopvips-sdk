...
interface WholeSaleServiceIf{
	...
	public function getAfterSaleApplyId( $st_query_time, $et_query_time, $page, $limit);
	
	public function getAfterSaleDetail( $apply_ids);
	
	public function getOrder( $st_query_time, $et_query_time, $page, $limit);
...
class _WholeSaleServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\NewRetail\WholeSaleServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.NewRetail.WholeSaleService", "1.0.0");
	}
	
	
	public function getAfterSaleApplyId( $st_query_time, $et_query_time, $page, $limit){
		
		$this->send_getAfterSaleApplyId( $st_query_time, $et_query_time, $page, $limit);
		return $this->recv_getAfterSaleApplyId();
	}
	...
	public function getAfterSaleDetail( $apply_ids){
		...
		$this->send_getAfterSaleDetail( $apply_ids);
		return $this->recv_getAfterSaleDetail();
	}
	...
	public function getOrder( $st_query_time, $et_query_time, $page, $limit){
		...
		$this->send_getOrder( $st_query_time, $et_query_time, $page, $limit);
...
class WholeSaleService_getAfterSaleApplyId_args {
...
class WholeSaleService_getAfterSaleDetail_args {
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('apply_ids');
		...
		foreach ($this->apply_ids as $iter0){
...
class WholeSaleService_getOrder_args {
...
class WholeSaleService_getOrderDetail_args {
...
class WholeSaleService_healthCheck_args {
...
class WholeSaleService_getAfterSaleApplyId_result {
...
class WholeSaleService_getAfterSaleDetail_result {
...
class WholeSaleService_getOrder_result {
...
class WholeSaleService_getOrderDetail_result {
...
class WholeSaleService_healthCheck_result {
