...
class WholeSaleServiceClient{
	...
	public static function getService(){
		...
		if (! WholeSaleServiceClient::$isRegis){
			
			WholeSaleServiceClient::regis ();
			WholeSaleServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = WholeSaleServiceClient::$DEFAULT_PROXY_IP;
		$port = WholeSaleServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\NewRetail\WholeSaleServiceHelper();
	}
