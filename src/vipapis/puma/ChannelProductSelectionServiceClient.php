...
class ChannelProductSelectionServiceClient{
	...
	public static function getService(){
		...
		if (! ChannelProductSelectionServiceClient::$isRegis){
			
			ChannelProductSelectionServiceClient::regis ();
			ChannelProductSelectionServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ChannelProductSelectionServiceClient::$DEFAULT_PROXY_IP;
		$port = ChannelProductSelectionServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\puma\ChannelProductSelectionServiceHelper();
	}
