...
class ChannelPumaServiceClient{
	...
	public static function getService(){
		...
		if (! ChannelPumaServiceClient::$isRegis){
			
			ChannelPumaServiceClient::regis ();
			ChannelPumaServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ChannelPumaServiceClient::$DEFAULT_PROXY_IP;
		$port = ChannelPumaServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\puma\ChannelPumaServiceHelper();
	}
