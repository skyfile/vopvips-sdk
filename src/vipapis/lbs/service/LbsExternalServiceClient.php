...
class LbsExternalServiceClient{
	...
	public static function getService(){
		...
		if (! LbsExternalServiceClient::$isRegis){
			
			LbsExternalServiceClient::regis ();
			LbsExternalServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = LbsExternalServiceClient::$DEFAULT_PROXY_IP;
		$port = LbsExternalServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\lbs\service\LbsExternalServiceHelper();
	}
