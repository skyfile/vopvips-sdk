...
interface ReportServiceIf{
	...
	public function getCountOfServiceInvoke( $invoke_date);
	
	public function healthCheck();
	
}

class _ReportServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\report\ReportServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.report.ReportService", "1.0.0");
	}
	
	
	public function getCountOfServiceInvoke( $invoke_date){
		
		$this->send_getCountOfServiceInvoke( $invoke_date);
		return $this->recv_getCountOfServiceInvoke();
	}
...
class ReportService_getCountOfServiceInvoke_args {
...
class ReportService_healthCheck_args {
...
class ReportService_getCountOfServiceInvoke_result {
...
class ReportService_healthCheck_result {
