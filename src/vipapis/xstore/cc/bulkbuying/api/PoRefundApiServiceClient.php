...
class PoRefundApiServiceClient{
	...
	public static function getService(){
		...
		if (! PoRefundApiServiceClient::$isRegis){
			
			PoRefundApiServiceClient::regis ();
			PoRefundApiServiceClient::$isRegis = true;
		}
		...
		return new \Voop\vipapis\xstore\cc\bulkbuying\api\PoRefundApiServiceHelper();
	}
