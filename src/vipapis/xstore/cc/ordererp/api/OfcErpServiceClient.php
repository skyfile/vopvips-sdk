...
class OfcErpServiceClient{
	...
	public static function getService(){
		...
		if (! OfcErpServiceClient::$isRegis){
			
			OfcErpServiceClient::regis ();
			OfcErpServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = OfcErpServiceClient::$DEFAULT_PROXY_IP;
		$port = OfcErpServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\xstore\cc\ordererp\api\OfcErpServiceHelper();
	}
