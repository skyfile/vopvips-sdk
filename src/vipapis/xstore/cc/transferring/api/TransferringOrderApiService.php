...
interface TransferringOrderApiServiceIf{
	...
	public function queryTransferringDeliveryForPDA( $start_delivery_time, $end_delivery_time, $transferring_type, $page, $page_size, $transferringOrderNo);
	...
	public function queryTransferringOrderForPDA( $transferring_types, $create_time_start, $create_time_end, $page, $page_size, $confirm_status, $transferringOrderNo);
	
	public function queryTransferringOrderItem( $transferring_order_no, $page, $page_size);
	
	public function queryTransferringReceipt( $start_received_time, $end_received_time, $transferring_type, $page, $page_size, $transferringOrderNo);
...
class _TransferringOrderApiServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\xstore\cc\transferring\api\TransferringOrderApiServiceIf{
	...
	public function queryTransferringDeliveryForPDA( $start_delivery_time, $end_delivery_time, $transferring_type, $page, $page_size, $transferringOrderNo){
		...
		$this->send_queryTransferringDeliveryForPDA( $start_delivery_time, $end_delivery_time, $transferring_type, $page, $page_size, $transferringOrderNo);
	...
	public function queryTransferringOrderForPDA( $transferring_types, $create_time_start, $create_time_end, $page, $page_size, $confirm_status, $transferringOrderNo){
		...
		$this->send_queryTransferringOrderForPDA( $transferring_types, $create_time_start, $create_time_end, $page, $page_size, $confirm_status, $transferringOrderNo);
	...
	public function queryTransferringReceipt( $start_received_time, $end_received_time, $transferring_type, $page, $page_size, $transferringOrderNo){
		...
		$this->send_queryTransferringReceipt( $start_received_time, $end_received_time, $transferring_type, $page, $page_size, $transferringOrderNo);
...
class TransferringOrderApiService_queryTransferringDeliveryForPDA_args {
	...
	public function write($output){
		...
		if($this->transferringOrderNo !== null) {
