...
class TransferringBatchImportDetailRes {
	...
	public function getName(){
		...
		return 'TransferringBatchImportDetailRes';
	}
			...
			if ("results" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem0 = new \Voop\vipapis\xstore\cc\transferring\api\TransferringBatchImportItemResult();
						$elem0->read($input);
