...
class TransferringOrderApiServiceClient{
	...
	public static function getService(){
		...
		if (! TransferringOrderApiServiceClient::$isRegis){
			
			TransferringOrderApiServiceClient::regis ();
			TransferringOrderApiServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = TransferringOrderApiServiceClient::$DEFAULT_PROXY_IP;
		$port = TransferringOrderApiServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\xstore\cc\transferring\api\TransferringOrderApiServiceHelper();
	}
