...
class _PriceServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\xstore\cc\price\api\PriceServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.xstore.cc.price.api.PriceService", "1.0.0");
	}
	
	
	public function confirmPricingReceipt( $pricing_nos){
		
		$this->send_confirmPricingReceipt( $pricing_nos);
		return $this->recv_confirmPricingReceipt();
	}
	...
	public function queryProdRetailPrice( $prod_items){
		...
		$this->send_queryProdRetailPrice( $prod_items);
		return $this->recv_queryProdRetailPrice();
	}
...
class PriceService_confirmPricingReceipt_args {
	
	static $_TSPEC;
	public $pricing_nos = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['pricing_nos'])){
				
				$this->pricing_nos = $vals['pricing_nos'];
			}
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('pricing_nos');
		...
		foreach ($this->pricing_nos as $iter0){
...
class PriceService_confirmStoreSalePriceChange_args {
...
class PriceService_healthCheck_args {
...
class PriceService_queryPricingReceipt_args {
...
class PriceService_queryPricingReceiptItem_args {
...
class PriceService_queryProdRetailPrice_args {
	
	static $_TSPEC;
	public $prod_items = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['prod_items'])){
				
				$this->prod_items = $vals['prod_items'];
			}
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('prod_items');
		...
		$output->writeListBegin();
		foreach ($this->prod_items as $iter0){
...
class PriceService_queryStoreSalePriceChange_args {
...
class PriceService_confirmPricingReceipt_result {
...
class PriceService_confirmStoreSalePriceChange_result {
...
class PriceService_healthCheck_result {
...
class PriceService_queryPricingReceipt_result {
...
class PriceService_queryPricingReceiptItem_result {
...
class PriceService_queryProdRetailPrice_result {
...
class PriceService_queryStoreSalePriceChange_result {
