...
class InventoryFlowServiceClient{
	...
	public static function getService(){
		...
		if (! InventoryFlowServiceClient::$isRegis){
			
			InventoryFlowServiceClient::regis ();
			InventoryFlowServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = InventoryFlowServiceClient::$DEFAULT_PROXY_IP;
		$port = InventoryFlowServiceClient::$DEFAULT_PROXY_PORT;	
		try{
