...
interface InventoryFlowServiceIf{
	...
	public function pushUnknownFlows( $id, $companyCode);
	
	public function receiving( $items);
	
}

class _InventoryFlowServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\xstore\inventory\InventoryFlowServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.xstore.inventory.InventoryFlowService", "1.0.0");
	}
	...
	public function pushUnknownFlows( $id, $companyCode){
		...
		$this->send_pushUnknownFlows( $id, $companyCode);
		return $this->recv_pushUnknownFlows();
	}
...
class InventoryFlowService_healthCheck_args {
...
class InventoryFlowService_pushUnknownFlows_args {
...
class InventoryFlowService_receiving_args {
...
class InventoryFlowService_healthCheck_result {
...
class InventoryFlowService_pushUnknownFlows_result {
...
class InventoryFlowService_receiving_result {
