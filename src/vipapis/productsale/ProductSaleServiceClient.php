...
class ProductSaleServiceClient{
	...
	public static function getService(){
		...
		if (! ProductSaleServiceClient::$isRegis){
			
			ProductSaleServiceClient::regis ();
			ProductSaleServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ProductSaleServiceClient::$DEFAULT_PROXY_IP;
		$port = ProductSaleServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\productsale\ProductSaleServiceHelper();
	}
