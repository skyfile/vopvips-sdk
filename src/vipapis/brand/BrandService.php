...
interface BrandServiceIf{
	...
	public function getBrandStories( $brand_ids);
	
	public function getVendorBrandRelationshipByVendorId( $vendor_id);
	
	public function healthCheck();
	
	public function multiGetBrand( $search_type, $word, $page, $limit);
	
}

class _BrandServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\brand\BrandServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.brand.BrandService", "1.0.0");
	}
...
class BrandService_getBrandInfo_args {
...
class BrandService_getBrandStories_args {
	
	static $_TSPEC;
	public $brand_ids = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['brand_ids'])){
				
				$this->brand_ids = $vals['brand_ids'];
			}
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('brand_ids');
		...
		foreach ($this->brand_ids as $iter0){
...
class BrandService_getVendorBrandRelationshipByVendorId_args {
...
class BrandService_healthCheck_args {
...
class BrandService_multiGetBrand_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$names = \Voop\vipapis\brand\BrandSearchType::$__names;
			$name = null;
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('word');
...
class BrandService_getBrandInfo_result {
...
class BrandService_getBrandStories_result {
...
class BrandService_getVendorBrandRelationshipByVendorId_result {
...
class BrandService_healthCheck_result {
...
class BrandService_multiGetBrand_result {
