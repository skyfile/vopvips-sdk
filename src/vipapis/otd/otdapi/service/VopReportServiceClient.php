...
class VopReportServiceClient{
	...
	public static function getService(){
		...
		if (! VopReportServiceClient::$isRegis){
			
			VopReportServiceClient::regis ();
			VopReportServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VopReportServiceClient::$DEFAULT_PROXY_IP;
		$port = VopReportServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\otd\otdapi\service\VopReportServiceHelper();
	}
