...
class TpcExternalServiceClient{
	...
	public static function getService(){
		...
		if (! TpcExternalServiceClient::$isRegis){
			
			TpcExternalServiceClient::regis ();
			TpcExternalServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = TpcExternalServiceClient::$DEFAULT_PROXY_IP;
		$port = TpcExternalServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\tpc\service\TpcExternalServiceHelper();
	}
