...
class _VrwInvIncomeOspServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\inventory\VrwInvIncomeOspServiceIf{
	...
	public function __construct(){
		...
		parent::__construct("vipapis.inventory.VrwInvIncomeOspService", "1.0.1");
	}
...
class VrwInvIncomeOspService_healthCheck_args {
...
class VrwInvIncomeOspService_syncVrwIncrInv_args {
...
class VrwInvIncomeOspService_healthCheck_result {
...
class VrwInvIncomeOspService_syncVrwIncrInv_result {
