...
class WopInventoryPoServiceClient{
	...
	public static function getService(){
		...
		if (! WopInventoryPoServiceClient::$isRegis){
			
			WopInventoryPoServiceClient::regis ();
			WopInventoryPoServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = WopInventoryPoServiceClient::$DEFAULT_PROXY_IP;
		$port = WopInventoryPoServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\inventory\WopInventoryPoServiceHelper();
	}
