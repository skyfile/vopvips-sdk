...
class WopInventoryQueryServiceClient{
	...
	public static function getService(){
		...
		if (! WopInventoryQueryServiceClient::$isRegis){
			
			WopInventoryQueryServiceClient::regis ();
			WopInventoryQueryServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = WopInventoryQueryServiceClient::$DEFAULT_PROXY_IP;
		$port = WopInventoryQueryServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\inventory\WopInventoryQueryServiceHelper();
	}
