...
class _JitPriceServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\price\JitPriceServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.price.JitPriceService", "1.0.0");
	}
	...
	public function createPriceApplicationId( $vendor_id){
		...
		$this->send_createPriceApplicationId( $vendor_id);
		return $this->recv_createPriceApplicationId();
	}
...
class JitPriceService_confirmPriceApplication_args {
...
class JitPriceService_createPriceApplicationId_args {
...
class JitPriceService_getPriceApplication_args {
...
class JitPriceService_getPriceApplicationStatus_args {
...
class JitPriceService_healthCheck_args {
...
class JitPriceService_submitPriceApplication_args {
...
class JitPriceService_updatePriceApplication_args {
...
class JitPriceService_confirmPriceApplication_result {
...
class JitPriceService_createPriceApplicationId_result {
...
class JitPriceService_getPriceApplication_result {
...
class JitPriceService_getPriceApplicationStatus_result {
...
class JitPriceService_healthCheck_result {
...
class JitPriceService_submitPriceApplication_result {
...
class JitPriceService_updatePriceApplication_result {
