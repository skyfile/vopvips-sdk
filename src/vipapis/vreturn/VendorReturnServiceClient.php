...
class VendorReturnServiceClient{
	...
	public static function getService(){
		...
		if (! VendorReturnServiceClient::$isRegis){
			
			VendorReturnServiceClient::regis ();
			VendorReturnServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VendorReturnServiceClient::$DEFAULT_PROXY_IP;
		$port = VendorReturnServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\vreturn\VendorReturnServiceHelper();
	}
