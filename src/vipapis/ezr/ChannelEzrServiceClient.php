...
class ChannelEzrServiceClient{
	...
	public static function getService(){
		...
		if (! ChannelEzrServiceClient::$isRegis){
			
			ChannelEzrServiceClient::regis ();
			ChannelEzrServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ChannelEzrServiceClient::$DEFAULT_PROXY_IP;
		$port = ChannelEzrServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\ezr\ChannelEzrServiceHelper();
	}
