...
class VendorCategoryMappingServiceClient{
	...
	public static function getService(){
		...
		if (! VendorCategoryMappingServiceClient::$isRegis){
			
			VendorCategoryMappingServiceClient::regis ();
			VendorCategoryMappingServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Voop\Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VendorCategoryMappingServiceClient::$DEFAULT_PROXY_IP;
		$port = VendorCategoryMappingServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \Voop\vipapis\isv\category\VendorCategoryMappingServiceHelper();
	}
