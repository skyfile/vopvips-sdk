...
interface VendorCategoryMappingServiceIf{
	...
	public function findMatchedSuccessfullMapping( $id);
	
	public function getVendorMappedCategories( $vendor_id, $vendor_category_id, $state);
...
class _VendorCategoryMappingServiceClient extends \Voop\Osp\Base\OspStub implements \Voop\vipapis\isv\category\VendorCategoryMappingServiceIf{
	
	public function __construct(){
		
		parent::__construct("vipapis.isv.category.VendorCategoryMappingService", "1.0.0");
	}
	
	
	public function findMatchedSuccessfullMapping( $id){
		
		$this->send_findMatchedSuccessfullMapping( $id);
		return $this->recv_findMatchedSuccessfullMapping();
	}
	...
	public function getVendorMappedCategories( $vendor_id, $vendor_category_id, $state){
		...
		$this->send_getVendorMappedCategories( $vendor_id, $vendor_category_id, $state);
		return $this->recv_getVendorMappedCategories();
	}
	...
	public function send_getVendorMappedCategories( $vendor_id, $vendor_category_id, $state){
		...
		$args->vendor_category_id = $vendor_category_id;
	...
	public function multiUpdateByPrimaryKeySelective( $records){
		...
		$this->send_multiUpdateByPrimaryKeySelective( $records);
		return $this->recv_multiUpdateByPrimaryKeySelective();
	}
	...
	public function selectByPrimaryKey( $id){
		...
		$this->send_selectByPrimaryKey( $id);
		return $this->recv_selectByPrimaryKey();
	}
	...
	public function selectByPrimaryKeys( $id){
		...
		$this->send_selectByPrimaryKeys( $id);
		return $this->recv_selectByPrimaryKeys();
	}
...
class VendorCategoryMappingService_findMatchedSuccessfullMapping_args {
...
class VendorCategoryMappingService_getVendorMappedCategories_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$names = \Voop\com\vip\isv\category\MappedCategoryState::$__names;
			$name = null;
...
class VendorCategoryMappingService_healthCheck_args {
...
class VendorCategoryMappingService_insertSelective_args {
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('record');
...
class VendorCategoryMappingService_multiUpdateByPrimaryKeySelective_args {
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('records');
...
class VendorCategoryMappingService_selectByCondition_args {
...
class VendorCategoryMappingService_selectByPrimaryKey_args {
...
class VendorCategoryMappingService_selectByPrimaryKeys_args {
...
class VendorCategoryMappingService_updateByPrimaryKeySelective_args {
...
class VendorCategoryMappingService_findMatchedSuccessfullMapping_result {
...
class VendorCategoryMappingService_getVendorMappedCategories_result {
...
class VendorCategoryMappingService_healthCheck_result {
...
class VendorCategoryMappingService_insertSelective_result {
...
class VendorCategoryMappingService_multiUpdateByPrimaryKeySelective_result {
...
class VendorCategoryMappingService_selectByCondition_result {
...
class VendorCategoryMappingService_selectByPrimaryKey_result {
...
class VendorCategoryMappingService_selectByPrimaryKeys_result {
...
class VendorCategoryMappingService_updateByPrimaryKeySelective_result {
